...
- ## High Risk Findings
    - ### [H-01. Users can avoid liquidation while being under the primary liquidation ratio if on the last short record](#H-01)
    - ### [H-02. Flagger Ids are reused too early, potentially blocking flaggers from liquidating in there allocated time](#H-02)
- ## Medium Risk Findings
    - ### [M-01. Combining shorts can incorrectly reset the shorts flag](#M-01)
- ## Low Risk Findings
    - ### [L-01. Last short does not reset liquidation flag after user gets fully liquidated, meaning healthy position will still be flagged if another order gets filled.](#L-01)
    - ### [L-02. Last short does not reset liquidation flag after user exits position fully, meaning healthy position will still be flagged if another order gets filled](#L-02)
    - ### [L-03. Partial filled short does not reset liquidation flag after user gets fully liquidated, meaning healthy position will still be flagged if the rest of the order gets filled.](#L-03)
    - ### [L-04. Partial filled short does not reset flag after user exits position fully, meaning healthy position will still be flagged if the rest of the order gets filled.](#L-04)
    - ### [L-05.  Protocol doesn’t take into account RETH/STETH requirements](#L-05)
    - ### [L-06. User can accidentally or maliciously combine the same short](#L-06)
    - ### [L-07. Users who are flagged and get back to a healthy ratio through price increase are still flagged contrary to the docs](#L-07)
    - ### [L-08. collateral ratio can never be the max](#L-08)
    - ### [L-09. Event in secondaryLiquidation could be misused to show false liquidations ](#L-09)
...
## <a id='H-01'></a>H-01. Users can avoid liquidation while being under the primary liquidation ratio if on the last short record            
...
```
## <a id='H-02'></a>H-02. Flagger Ids are reused too early, potentially blocking flaggers from liquidating in there allocated time            
...
## <a id='M-01'></a>M-01. Combining shorts can incorrectly reset the shorts flag            
...
## <a id='L-01'></a>L-01. Last short does not reset liquidation flag after user gets fully liquidated, meaning healthy position will still be flagged if another order gets filled.            
...
```
## <a id='L-02'></a>L-02. Last short does not reset liquidation flag after user exits position fully, meaning healthy position will still be flagged if another order gets filled            
...
```
## <a id='L-03'></a>L-03. Partial filled short does not reset liquidation flag after user gets fully liquidated, meaning healthy position will still be flagged if the rest of the order gets filled.            
...
```
## <a id='L-04'></a>L-04. Partial filled short does not reset flag after user exits position fully, meaning healthy position will still be flagged if the rest of the order gets filled.            
...
```
## <a id='L-05'></a>L-05.  Protocol doesn’t take into account RETH/STETH requirements            
...
**Implement Constraint Adherence:**
...
## <a id='L-06'></a>L-06. User can accidentally or maliciously combine the same short            
...
```
## <a id='L-07'></a>L-07. Users who are flagged and get back to a healthy ratio through price increase are still flagged contrary to the docs            
...
## <a id='L-08'></a>L-08. collateral ratio can never be the max            
...
## <a id='L-09'></a>L-09. Event in secondaryLiquidation could be misused to show false liquidations             
